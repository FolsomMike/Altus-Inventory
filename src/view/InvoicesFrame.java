/*******************************************************************************
* Title:  InvoicesFrame.java
* Author: Hunter Schoonover
* Date: 08/14/15
*
* Purpose:
*
* This class is the Invoices window.
*
*/
...
public class  InvoicesFrame extends JFrame
{
    ...
    //--------------------------------------------------------------------------
    //  InvoicesFrame:: InvoicesFrame (constructor)
    //

    public  InvoicesFrame(MainView pMainView)
    {

        mainView = pMainView;

    }//end of  InvoicesFrame:: InvoicesFrame (constructor)
    //--------------------------------------------------------------------------
    ...
    }// end of  InvoicesFrame::init
    //--------------------------------------------------------------------------
    
    //--------------------------------------------------------------------------
    //  InvoicesFrame::centerJFrame
    //
    ...
    }// end of  InvoicesFrame::centerJFrame
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    //  InvoicesFrame::setUpFrame
    //
    ...
    }// end of  InvoicesFrame::setUpFrame
    //--------------------------------------------------------------------------

    //--------------------------------------------------------------------------
    //  InvoicesFrame::setupGUI
    //
    ...
    }// end of  InvoicesFrame::setupGui
    //--------------------------------------------------------------------------

}//end of class  InvoicesFrame
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
