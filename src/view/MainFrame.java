...
public class MainFrame extends SkoonieFrame
{
    ...
    //--------------------------------------------------------------------------
    // MainFrame::deleteTruckDriver
    //
    // Deletes the truck driver selected in the Truck Drivers window.
    //
    ...
    }// end of MainFrame::deleteTruckDriver
    //--------------------------------------------------------------------------
    ...
    }// end of MainFrame::displayCreateTruckCompanyWindow
    //--------------------------------------------------------------------------
    
    //--------------------------------------------------------------------------
    // MainFrame::displayCreateTruckDriverWindow
    //
    // Displays the Create Truck Driver window.
    //
    ...
    }// end of MainFrame::displayEditTruckCompanyWindow
    //--------------------------------------------------------------------------
    ...
    }// end of MainFrame::displayEditTruckWindow
    //--------------------------------------------------------------------------
    ...
    public void displayMaterialInfoWindow() 
    {
        ...
        MaterialInfoWindow w = new MaterialInfoWindow(getSelectedBatch(), this,
                                                        mainView);
        w.init();
        
    }// end of MainFrame::displayMaterialInfoWindow
    //--------------------------------------------------------------------------
